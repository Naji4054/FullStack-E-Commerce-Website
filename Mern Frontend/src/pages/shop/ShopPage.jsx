...
const endProduct = startProduct + products.length - 1;
  ...
  return (
   <>
        ...
        <p className='section__subheader'>Browse a diverse range of categories , from chic dreese to versatile acceessories. Elavate your own style today!</p>
      </section>
      <section className='section__container'>
        <div className='flex flex-col md:flex-row md:gap-12 gap-8'>
            ...
            {/*right side*/}
            <div>
                <h3 className='text-cl font-medium mb-4'>Showing { startProduct} to {endProduct} of { totalProducts} products</h3>
